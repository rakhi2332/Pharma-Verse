...
export default function SemesterList() {
  ...
  useEffect(() => {
    // Background sync if API backend exists
    axios.get(`${API_BASE_URL}/semesters`, { timeout: 1500 })
      .then(res => {
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-12 pb-8">
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-sm font-semibold text-primary uppercase tracking-wider">PCI Curriculum</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-extrabold text-text-main tracking-tight mb-4">
              B.Pharmacy Semesters
            </h1>
            <p className="text-lg text-text-muted max-w-3xl leading-relaxed">
              Explore subject notes, syllabus topics, and model answer keys categorized by PCI semester.
            </p>
